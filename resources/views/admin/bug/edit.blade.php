...
<div class="navbar-breadcrumb">
                    ...
                    <div class="col-sm-12">
                     <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                           <form action="{{ route('admin.bug.update', [$bug->id])}}" method="post" enctype="multipart/form-data" 
        ...
        {{$errors->first('name')}}
                              ...
                              <select name="status" class="form-control {{$errors->first('status') ? 'is-invalid' : ''}}" id="" value="{{$bug->status ?? ''}}">
                              ...
                              <div class="invalid-feedback">
                              Invalid custom status feedback </div>
                              </div>
