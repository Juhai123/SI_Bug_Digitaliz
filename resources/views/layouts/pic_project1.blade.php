            ...
            <div id="sidebar-scrollbar">
               <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     ...
                     <li class="{{ Request()->routeIs('pic.index') ? 'active' : '' }}">
                     ...
                     <li class="{{ Request()->routeIs('pic.bug.*') ? 'active' : '' }}">
                        <a href="{{ route('pic.bug.index') }}">
                           <i class="las la-bug"></i><span>Bug</span></a>
                     </li> <!-- End Task -->

                     <li class="{{ Request()->routeIs('pic.project.*') ? 'active' : '' }}">
                        <a href="{{ route('pic.project.index') }}">
